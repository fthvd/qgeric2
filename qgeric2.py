...
# Qgeric2: Graphical queries by drawing simple shapes.
...
from .qgericsettings import QgericSettings
...
class Qgeric2:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qdrawEVT/resources/icon_Settings.png'
        self.add_action(
            icon_path,
